...
<div align="center">
  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=6366F1&center=true&vCenter=true&width=600&lines=Full+Stack+Web+Developer;PHP+%7C+MySQL+%7C+JavaScript;Modern+Web+Solutions)
  
  [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/muhammet-mert-durgut-810107389)
  [![Portfolio](https://img.shields.io/badge/Portfolio-6366F1?style=for-the-badge&logo=google-chrome&logoColor=white)](https://mertdurgut.net)
  [![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:muhammetmertdurgut@gmail.com)
...
Bilgisayar Programcılığı öğrencisi ve tutkulu bir **Full Stack Web Developer**'ım. Modern web teknolojileri ile kullanıcı dostu, performanslı ve güvenli web uygulamaları geliştiriyorum.
...
### 🍽️ [QR Menü Yönetim Sistemi](https://qrmenu.mertdurgut.net)
Restoran ve kafeler için geliştirilmiş modern dijital menü sistemi
- **Tech Stack:** PHP, MySQL, Tailwind CSS, Alpine.js
- **Özellikler:** QR kod entegrasyonu, Admin paneli, Responsive tasarım

### 🛒 [Modern E-Ticaret Platformu](https://eticaret.mertdurgut.net)
Kapsamlı B2C e-ticaret çözümü
- **Tech Stack:** PHP, MySQL, HTML5, SASS, JavaScript
- **Özellikler:** Dinamik kampanya yönetimi, Gelişmiş filtreleme, CRM entegrasyonu

### 🚗 Galericiler için Araç Takip Sistemi
Araç stok ve satış yönetim platformu
- **Tech Stack:** PHP, MySQL, Modern CSS/JS
- **Özellikler:** Stok takibi, Müşteri yönetimi, Raporlama

### 🔧 Yedek Parça E-Ticaret Sistemi
Oto yedek parça satış platformu
- **Tech Stack:** PHP, MySQL, HTML5, CSS3, JavaScript
- **Özellikler:** Araç modeline göre filtreleme, Sepet sistemi, Admin paneli
